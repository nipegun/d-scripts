...
do
  case $choice in
    ...
    5)
      ...
      echo ""
      sleep 2
      apt-get -y install hdparm ntfs-3g cifs-utils hfsplus hfsprogs hfsutils sshfs ecryptfs-utils
    ...
    6)
      ...
      echo ""
      sleep 2
      apt-get -y install whois nmap nbtscan mailutils wireless-tools wpasupplicant
    ...
    7)
      ...
      apt-get -y install testdisk dialog hddtemp manpages-es mc nano members sysv-rc-conf zip unzip elinks python rsync
      ...
      echo ""
      apt-get -y install unace rar unrar unar p7zip-rar p7zip zip unzip 
    ;;
