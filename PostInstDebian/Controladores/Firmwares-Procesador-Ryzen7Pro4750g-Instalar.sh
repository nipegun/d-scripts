...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/PostInstDebian/Controladores/Firmwares-Procesador-Ryzen7Pro4750g-Instalar.sh | bash
# ----------
