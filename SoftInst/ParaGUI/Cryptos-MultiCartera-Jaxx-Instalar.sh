...
#
#  Ejecución remota:
#  curl -s https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaGUI/Cryptos-MultiCartera-Jaxx-Instalar.sh | bash
#
#  Ejecución remota sin caché:
#  curl -s -H 'Cache-Control: no-cache, no-store' https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaGUI/Cryptos-MultiCartera-Jaxx-Instalar.sh | bash
# ----------
...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo -e "${ColorAzulClaro}  Iniciando el script de instalación de Jaxx para Debian 7 (Wheezy)...${FinColor}"
  echo ""
  ...
  echo ""
  echo -e "${ColorAzulClaro}  Iniciando el script de instalación de Jaxx para Debian 8 (Jessie)...${FinColor}"
  echo ""
  ...
  echo ""
  echo -e "${ColorAzulClaro}  Iniciando el script de instalación de Jaxx para Debian 9 (Stretch)...${FinColor}"
  echo ""
  ...
  echo ""
  echo -e "${ColorAzulClaro}  Iniciando el script de instalación de Jaxx para Debian 10 (Buster)...${FinColor}"
  echo ""
  ...
  echo ""
  echo -e "${ColorAzulClaro}  Iniciando el script de instalación de Jaxx para Debian 11 (Bullseye)...${FinColor}"
  echo ""
