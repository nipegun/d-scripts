...
# ----------
# Script de NiPeGun para instalar y configurar TORBrowser en Debian
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaGUI/TORBrowser-Instalar.sh | bash
# ----------
