...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaGUI/Flash-Instalar.sh | bash
# ----------
...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de Flash para Debian 7 (Wheezy)..."  echo "-----------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de Flash para Debian 8 (Jessie)..."  echo "-----------------------------------------------------------------------------"
  echo ""
