...
# ----------
# Script de NiPeGun para instalar herramientas para volúmenes en Debian
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaCLI/Herramientas-Volumenes-Instalar.sh | bash
# ----------
