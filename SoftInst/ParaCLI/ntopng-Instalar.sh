...
# Ejecutar comandos dependiendo de la versión de Debian detectada
  ...
  if [ $cVerSO == "13" ]; then
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 13 (x)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 11 (Bullseye)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 10 (Buster)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 9 (Stretch)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 8 (Jessie)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de ntopng para Debian 7 (Wheezy)...${cFinColor}"
    echo ""
