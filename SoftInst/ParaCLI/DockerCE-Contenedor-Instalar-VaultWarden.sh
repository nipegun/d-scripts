    ...
    do
      case $choice in
        ...
        1)
          ...
          echo ""
          echo -e "${vColorVerde}  Instalando VaultWarden en un ordenador o máquina virtual...${vFinColor}"
          echo ""
        ...
        2)
          ...
          echo ""
          echo -e "${vColorVerde}  Instalando VaultWarden en un contenedor LXC...${vFinColor}"
          echo ""
