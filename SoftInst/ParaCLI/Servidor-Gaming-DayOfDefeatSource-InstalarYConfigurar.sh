...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo "------------------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación del servidor gaming de Day of Defeat Source para Debian 7 (Wheezy)..."  echo "------------------------------------------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "------------------------------------------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación del servidor gaming de Day of Defeat Source para Debian 8 (Jessie)..."  echo "------------------------------------------------------------------------------------------------------------"
  echo ""
