...
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/SoftInst/ParaCLI/Dockers/Nessus.sh | bash
#
...
# Crear el menú
  ...
  menu=(dialog --checklist "¿Donde quieres instalar Nessus?:" 22 76 16)
    opciones=(
