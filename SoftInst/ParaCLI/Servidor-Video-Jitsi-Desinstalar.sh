...
# ----------
# Script de NiPeGun para desinstalar Jitsi de Debian
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaCLI/Servidor-Video-Jitsi-Desinstalar.sh | bash
# ----------
...
if [ $cVerSO == "7" ]; then
  ...
  echo "  Iniciando el script de desinstalación de xxxxxxxxx para Debian 10 (Buster)..."  
  echo ""

  echo ""
  echo -e "${cColorVerde}  Desinstalando jitsi-meet...${cFinColor}"
  echo ""
