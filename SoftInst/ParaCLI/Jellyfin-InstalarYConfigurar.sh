...
if [ $OS_VERS == "7" ]; then
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de Jellyfin para Debian 7 (Wheezy)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de Jellyfin para Debian 8 (Jessie)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de Jellyfin para Debian 9 (Stretch)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de Jellyfin para Debian 10 (Buster)...${vFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Iniciando el script de instalación de Jellyfin para Debian 11 (Bullseye)...${vFinColor}"
  echo ""
