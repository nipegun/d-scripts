...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de DDClient para Debian 7 (Wheezy)..."  echo "-----------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de DDClient para Debian 8 (Jessie)..."  echo "-----------------------------------------------------------------------------"
  echo ""
