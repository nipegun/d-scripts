...
# Ejecutar comandos dependiendo de la versión de Debian detectada
  ...
  if [ $cVerSO == "13" ]; then
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 13 (x)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 12 (Bookworm)...${cFinColor}"
    echo ""
    ...
    # Instalar el paquete principal
      echo ""
      echo "    Instalando el paquete principal..."
      echo ""
      apt-get -y install cockpit

    # Instalar extenxiones
      echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 11 (Bullseye)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 10 (Buster)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 9 (Stretch)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 8 (Jessie)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de Cockpit para Debian 7 (Wheezy)...${cFinColor}"
    echo ""
