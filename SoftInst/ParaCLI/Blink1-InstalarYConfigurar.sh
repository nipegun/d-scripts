...
#
# Ejecución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/SoftInst/ParaCLI/Blink1-InstalarYConfigurar.sh | bash
# ----------
...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de Blink1 para Debian 7 (Wheezy)..."  echo "-----------------------------------------------------------------------------"
  echo ""
  ...
  echo ""
  echo "-----------------------------------------------------------------------------"
  echo "  Iniciando el script de instalación de Blink1 para Debian 8 (Jessie)..."  echo "-----------------------------------------------------------------------------"
  echo ""
