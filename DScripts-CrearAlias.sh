...
ln -s /root/scripts/d-scripts/Texto-BuscarYReemplazarEnArchivosDeTodoElSistema.sh  /root/scripts/d-scripts/Alias/tbyreadtes
ln -s /root/scripts/d-scripts/Texto-BuscarEnContenidosDeArchivosDeLaCarpeta.sh     /root/scripts/d-scripts/Alias/tbecdadlc
ln -s /root/scripts/d-scripts/Texto-BuscarEnContenidosDeArchivosDeTodoElSistema.sh /root/scripts/d-scripts/Alias/tbecdadtes
ln -s /root/scripts/d-scripts/Texto-BuscarEnNombresDeArchivosDeLaCarpeta.sh        /root/scripts/d-scripts/Alias/tbendadlc
ln -s /root/scripts/d-scripts/Texto-BuscarEnNombresDeArchivosDeTodoElSistema.sh    /root/scripts/d-scripts/Alias/tbendadtes
