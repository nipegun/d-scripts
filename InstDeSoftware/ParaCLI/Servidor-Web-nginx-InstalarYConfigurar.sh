...
if [ $cVerSO == "13" ]; then
  ...
  echo ""
  echo "  Iniciando el script de instalación de nginx para Debian 13 (x)..."  
  echo ""
  ...
  echo ""
  echo "  Iniciando el script de instalación de nginx para Debian 12 (Bookworm)..."  
  echo ""
  ...
  do
    case $choice in
      ...
      7)
        ...
        # Crear la web protegida
          mkdir -p /var/www/html/protegida/
          echo '<!DOCTYPE html>'                      > /var/www/html/protegida/index.html
          echo '<html lang="es">'                    >> /var/www/html/protegida/index.html
          echo "  <head>"                            >> /var/www/html/protegida/index.html
          echo "    <meta charset='UTF-8'>"          >> /var/www/html/protegida/index.html
          echo "    <title>Página protegida</title>" >> /var/www/html/protegida/index.html
          echo "  </head>"                           >> /var/www/html/protegida/index.html
          echo "  <body>"                            >> /var/www/html/protegida/index.html
          echo "    <p>Página protegida.</p>"        >> /var/www/html/protegida/index.html
          echo "  </body>"                           >> /var/www/html/protegida/index.html
          echo "</html>"                             >> /var/www/html/protegida/index.html
          chown www-data:www-data /var/www/html/protegida/index.html
