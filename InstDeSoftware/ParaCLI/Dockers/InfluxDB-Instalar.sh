...
# ----------
# Script de NiPeGun para instalar InfluxDB en el DockerCE de Debian
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/InstDeSoftware/ServWeb/Dockers/10020-10021-InfluxDB.sh | bash
#
# Ejecución remota como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/InstDeSoftware/ServWeb/Dockers/10020-10021-InfluxDB.sh | sed 's-sudo--g' | bash
#
# Comando: docker run -d --restart=always --name InfluxDB -p 3000:3000 influxdb/influxdb:latest
# ----------
...
# Notificar inicio de ejecución del script
  echo ""
  echo -e "${cColorAzulClaro}  Iniciando el script de instalación de InfluxDB en el DockerCE de Debian...${cFinColor}"
  echo ""
  ...
  for choice in $choices
    do
      ...
      1)
        ...
        echo ""
        echo -e "${cColorVerde}  Instalando InfluxDB en un ordenador o máquina virtual...${cFinColor}"
        echo ""

        # Crear carpetas
          sudo mkdir -p /Contenedores/InfluxDB/data/   2> /dev/null
        ...
        # Insertar el script iniciador en los comandos post arranque
          ...
          echo ""
          echo "/root/scripts/ParaEsteDebian/DockerCE-Cont-InfluxDB-Iniciar.sh" | sudo tee -a /root/scripts/ParaEsteDebian/ComandosPostArranque.sh

        # Iniciar el docker por primera vez
          echo ""
          echo "    Iniciando el container por primera vez..."
          echo ""
          sudo /root/scripts/ParaEsteDebian/DockerCE-Cont-InfluxDB-Iniciar.sh

        # Notificar fin de ejecución del script
          echo ""
          echo "  Script de instalación del Docker de InfluxDB, finalizado."
          echo ""
      ...
      2)
        ...
        echo ""
        echo -e "${cColorVerde}  Instalando InfluxDB en un contenedor LXC...${cFinColor}"
        echo ""

        # Crear carpetas
          sudo mkdir -p /Host/InfluxDB/data 2> /dev/null
          sudo mkdir -p /root/scripts/ParaEsteDebian/ 2> /dev/null
