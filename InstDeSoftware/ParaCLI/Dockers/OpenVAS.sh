...
# ----------
# Script de NiPeGun para instalar OpenVAS en el DockerCE de Debian
#
# Ejecución remota (puede requerir permisos sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/SoftInst/ParaCLI/Dockers/OpenVAS.sh | bash
#
...
# Crear el menú
  ...
  menu=(dialog --radiolist "¿Donde quieres instalar OpenVAS?:" 22 76 16)
    opciones=(
    ...
    do
      ...
      1)
        ...
        # Insertar el script iniciador en los comandos post arranque
          ...
          echo ""
          echo "/root/scripts/ParaEsteDebian/DockerCE-Cont-OpenVAS-Iniciar.sh" | sudo tee -a /root/scripts/ParaEsteDebian/ComandosPostArranque.sh

        # Iniciar el docker por primera vez
          echo ""
          echo "    Iniciando el container por primera vez..."
          echo ""
          sudo /root/scripts/ParaEsteDebian/DockerCE-Cont-OpenVAS-Iniciar.sh

        # Notificar fin de ejecución del script
          echo ""
          echo "  Script de instalación del Docker de OpenVAS, finalizado."
          echo ""
