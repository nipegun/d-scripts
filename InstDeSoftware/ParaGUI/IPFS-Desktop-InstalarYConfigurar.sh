...
# Ejecutar comandos dependiendo de la versión de Debian detectada
  ...
  if [ $cVerSO == "13" ]; then
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de IPFS Desktop para Debian 11 (Bullseye)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de IPFS Desktop para Debian 10 (Buster)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de IPFS Desktop para Debian 9 (Stretch)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de IPFS Desktop para Debian 8 (Jessie)...${cFinColor}"
    echo ""
    ...
    echo ""
    echo -e "${cColorAzulClaro}  Iniciando el script de instalación de IPFS Desktop para Debian 7 (Wheezy)...${cFinColor}"
    echo ""
