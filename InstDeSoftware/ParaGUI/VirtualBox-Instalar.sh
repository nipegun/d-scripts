        ...
        case $choice in
          ...
          1)
            ...
            # Instalar paquetes necesarios
             ...
             # Agregar repositorio
               ...
               sudo echo "deb [arch=$(dpkg --print-architecture)] http://download.virtualbox.org/virtualbox/debian rixie contrib" > /etc/apt/sources.list.d/virtualbox.list
               sudo apt-get -y update
          ...
          2)
            ...
            # Determinar el enlace de descarga del archivo .deb
              ...
              echo ""
              vEnlaceArchivoDeb=$(curl -sL https://download.virtualbox.org/virtualbox/$vUltVersEnWeb/ | grep rixie | cut -d'"' -f2)
