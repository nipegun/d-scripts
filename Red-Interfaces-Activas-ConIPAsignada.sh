...
if [ $cVerSO == "7" ]; then
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Determinando que interfaces activas tienen una IP asignada en Debian 7 (Wheezy)...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Determinando que interfaces activas tienen una IP asignada en Debian 8 (Jessie)...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Determinando que interfaces activas tienen una IP asignada en Debian 9 (Stretch)...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Determinando que interfaces activas tienen una IP asignada en Debian 10 (Buster)...${cFinColor}"
  echo ""
  ...
  echo ""
  echo -e "${vColorAzulClaro}  Determinando que interfaces activas tienen una IP asignada en Debian 11 (Bullseye)...${cFinColor}"
  echo ""
