...
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/Sistema/Particiones-Exportar-HaciaArchivosDeImagen.sh | bash -s [RutaAlDeviceDeLaUnidad] [CantDeParticiones]
#
# Ejecución remota con argumentos como root (para sistemas sin sudo):
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/Sistema/Particiones-Exportar-HaciaArchivosDeImagen.sh | sed 's-sudo--g' | bash -s [RutaAlDeviceDeLaUnidad] [CantDeParticiones]
#
# Bajar y editar directamente el archivo en nano
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/Sistema/Particiones-Exportar-HaciaArchivosDeImagen.sh | nano -
#
#  NOTAS:
