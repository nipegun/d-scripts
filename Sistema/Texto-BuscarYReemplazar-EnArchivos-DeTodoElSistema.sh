...
#
# Ejecución remota:
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/Sistema/Texto-BuscarYReemplazar-EnArchivos-DeTodoElSistema.sh | bash -s CadenaVieja CadenaNueva
# ----------
