...
#
#  Ejeución remota:
#  curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/master/Usuario-MineroCRP-AutologuearEnModoTexto-Desactivar.sh | bash
# ----------

# Se debe reemplazar la línea
# ExecStart=-/sbin/agetty --noclear -a minerocrp %I $TERM
# por
