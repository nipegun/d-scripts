...
#   curl -sL https://raw.githubusercontent.com/nipegun/d-scripts/refs/heads/master/Sistema/Modem-MBIM-Query-All.sh | sed 's-sudo--g' | bash
# ----------
...
#
  ...
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-device-caps

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-subscriber-ready-status...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-subscriber-ready-status

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-radio-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-radio-state

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-device-services...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-device-services

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-pin-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-pin-state

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-pin-list...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-pin-list

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-home-provider...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-home-provider

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-preferred-providers...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-preferred-providers

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-visible-providers...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-visible-providers

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-registration-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-registration-state

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-signal-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-signal-state

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-packet-service-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-packet-service-state
 
#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-packet-statistics...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-packet-statistics

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-provisioned-contexts...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-provisioned-contexts

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-network-idle-hint...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-network-idle-hint

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando query-emergency-mode...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --query-emergency-mode

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando phonebook-query-configuration...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --phonebook-query-configuration

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-firmware-id...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-firmware-id

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-sar-config...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-sar-config

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-transmission-status...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-transmission-status

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando atds-query-signal...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --atds-query-signal

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando atds-query-location...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --atds-query-location

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-lte-attach-configuration...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-lte-attach-configuration

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-lte-attach-info...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-lte-attach-info

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-sys-caps...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-sys-caps

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-device-caps...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-device-caps

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-device-slot-mappings...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-device-slot-mappings

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-location-info-status...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-location-info-status

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-provisioned-contexts...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-provisioned-contexts

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-base-stations-info...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-base-stations-info

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-registration-parameters...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-registration-parameters

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-modem-configuration...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-modem-configuration

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-wake-reason...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-wake-reason

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando quectel-query-radio-state...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --quectel-query-radio-state

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando intel-query-rfim...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --intel-query-rfim

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-nitz...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-nitz

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-uicc-application-list...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-uicc-application-list

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-uicc-atr...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-uicc-atr

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-uicc-reset...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-uicc-reset

#
  echo ""
  echo -e "${cColorAzulClaro}  Ejecutando ms-query-uicc-terminal-capability...${cFinColor}"
  echo ""
  sudo mbimcli --device="$vDevModem" --device-open-proxy --ms-query-uicc-terminal-capability
